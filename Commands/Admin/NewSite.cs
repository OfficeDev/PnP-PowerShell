...
namespace SharePointPnP.PowerShell.Commands
{
    ...
    [CmdletAdditionalParameter(ParameterType = typeof(SwitchParameter), ParameterName = "ShareByEmailEnabled", Mandatory = false, HelpMessage = @"Specifies if user will be able to grant permissions to guests for resources within the site collection", ParameterSetName = ParameterSet_COMMUNICATIONBUILTINDESIGN)]
    [CmdletAdditionalParameter(ParameterType = typeof(SwitchParameter), ParameterName = "ShareByEmailEnabled", Mandatory = false, HelpMessage = @"Specifies if user will be able to grant permissions to guests for resources within the site collection", ParameterSetName = ParameterSet_COMMUNICATIONCUSTOMDESIGN)]
